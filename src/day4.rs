...
fn compare(a: &Captures, b: &Captures) -> Ordering {
    let month = [
        a.get(1).unwrap().as_str().parse::<usize>().unwrap(),
        b.get(1).unwrap().as_str().parse::<usize>().unwrap(),
    ];
    let day = [
        a.get(2).unwrap().as_str().parse::<usize>().unwrap(),
        b.get(2).unwrap().as_str().parse::<usize>().unwrap(),
    ];
    let hour = [
        a.get(3).unwrap().as_str().parse::<usize>().unwrap(),
        b.get(3).unwrap().as_str().parse::<usize>().unwrap(),
    ];
    let minute = [
